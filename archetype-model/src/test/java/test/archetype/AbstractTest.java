...
public abstract class AbstractTest {
	...
	public void setUp() throws Exception {
		...
		try {
			applicationContext = new ClassPathXmlApplicationContext(new String[] {"/beans/application/context/archetype-model.xml",
					"/beans/application/context/archetype-model-log4j.xml",});
		} catch (Exception e) {
			logger.error(ExceptionUtils.getStackTrace(e));
		}
	}
