...
public abstract class AbstractTest {
	...
	public void setUp() throws Exception {
		...
		try {
			applicationContext = new ClassPathXmlApplicationContext(new String[] {"/beans/application/context/archetype-webapp.xml",
					"/beans/application/context/archetype-webapp-log4j.xml",});
		} catch (Exception e) {
			logger.error(ExceptionUtils.getStackTrace(e));
		}
	}
